  ...
  const navItems: NavItem[] = [
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 16l4-4m0 0l4 4m-4-4v4m0 0H8m4 0h4" />
        </svg>
      ),
    },
    {
    ...
    <aside className="w-64 bg-slate-800 text-white h-screen overflow-y-auto sticky top-0">
      ...
      <div className="p-6 border-b border-slate-700">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold">HR Hub</span>
        </div>
      </div>
